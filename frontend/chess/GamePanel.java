...
public class GamePanel extends JPanel{
	...
	public GamePanel(GameControl gc)
	{
	    ...
	    try {
			...
			blackRook = ImageIO.read(new File("Pieces/bRook.png"));
			blackKnight = ImageIO.read(new File("Pieces/bKnight.png"));
			blackBishop = ImageIO.read(new File("Pieces/bBishop.png"));
			blackQueen = ImageIO.read(new File("Pieces/bQueen.png"));
			blackKing = ImageIO.read(new File("Pieces/bKing.png"));
			//creating 8 black pawn pieces
			for (int i=0; i< 8; i++)
			{
				bPawnImages[i] = ImageIO.read(new File("Pieces/bPawn.png"));

			}
			
	    	//Reading the white piece files
			whiteRook = ImageIO.read(new File("Pieces/wRook.png"));
			whiteKnight = ImageIO.read(new File("Pieces/wKnight.png"));
			whiteBishop = ImageIO.read(new File("Pieces/wBishop.png"));
			whiteQueen = ImageIO.read(new File("Pieces/wQueen.png"));
			whiteKing = ImageIO.read(new File("Pieces/wKing.png"));
			//creating 8 white pawn pieces
			for (int i=0; i< 8; i++)
			{
				wPawnImages[i] = ImageIO.read(new File("Pieces/wPawn.png"));
